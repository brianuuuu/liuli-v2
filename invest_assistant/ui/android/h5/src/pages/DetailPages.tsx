...
export function NoteDetailPage() {
  ...
  const update = useMutation({
    mutationFn: () => mobileApi.updateNote(id, { content: content ?? query.data?.content ?? "", group_id: groupId === undefined ? query.data?.group_id : groupId, tags: tagsText ?? query.data?.tags_text }),
